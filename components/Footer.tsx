    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container">
        <div className="grid gap-8 md:grid-cols-4">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <Image
                src="/logo.png"
                alt="Project Rebirth Logo"
                width={40}
                height={40}
                className="h-10 w-auto"
              />
              <span className="font-bold text-white">Project Rebirth</span>
            </div>
            <p className="text-gray-400">
              A young feminist-led social enterprise for the economic empowerment of women in marginalized
              communities.
            </p>
          </div>
          <div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Project Rebirth. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
